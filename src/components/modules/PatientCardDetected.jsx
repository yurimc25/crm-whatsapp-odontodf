...
// Definição de cores para manter o padrão do seu ChatWindow
const T = {
  text:      "#ececec",
  sub:       "#8e8e8e",
  accent:    "#d4956a",
...
const PatientCardDetected = ({ msg }) => {
  if (!msg || !msg.text) return null;

  // Tenta extrair dados básicos para exibição rápida no card
  ...
  const nome = data["nome"] || data["nome completo"] || "Paciente";
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
          ...
          <div style={{ fontWeight: "bold", color: T.accent, fontSize: "14px" }}>
            FICHA DE PACIENTE DETECTADA
          </div>
        </div>
        
        <div style={{ color: T.text, fontSize: "13px", lineHeight: "1.6" }}>
          <strong>Nome:</strong> {nome} <br />
          {telefone && <><strong>Tel:</strong> {telefone} <br /></>}
        </div>
...
export default PatientCardDetected;
